...
function ZonalDrawControl({ onStats }) {
  ...
  useEffect(() => {
    ...
    const onCreated = async (e) => {
      ...
      const res = await fetch(`${API_BASE}/shadows/zonal?table=puntos_no_parcelas`, {
